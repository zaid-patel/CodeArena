...
//   }
  ...
  useEffect(() => {
    const fetchSubmissions = async () => {
      setLoading(true)
      try {
        const res = await axios.get(`${BACKEND_URL}/contest/submissions/${contestId}`, {
          headers: {
  ...
  return (
    <div className="container py-8">
      <div className="mb-6 flex items-center justify-between">
        <h1 className="text-2xl font-bold">Contest Submissions</h1>
            ...
            <TableBody>
              ...
              {submissions.map((sub) => (
                ...
                >
                  ...
                  <TableCell>
                    <Link href={`/contests/${contestId}/problems/${sub.problemId}`} className="underline hover:text-primary">
                      {sub.problemId}
                    </Link>
                  </TableCell>
                </TableRow>
